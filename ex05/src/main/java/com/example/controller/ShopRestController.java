...
public class ShopRestController {
	...
	public void attachInsert(String code, MultipartHttpServletRequest multi) throws Exception{
		List<MultipartFile> files=multi.getFiles("files");
		String strPath="c:/upload/shop/"+code;
		...
		for(MultipartFile file:files){
			if(file.isEmpty()){
				...
				File newFile = new File (strPath +"/"+strFile);
				if(!newFile.exists()){
